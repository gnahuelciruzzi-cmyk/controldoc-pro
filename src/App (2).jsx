  ...
  return (
    <div className="px-8 pb-10">
      <div className="grid grid-cols-2 gap-4 mb-6">
        <KpiCard label="Reportes disponibles" value={reportes.length} sub="listos para exportar" />
        <KpiCard label="Próximamente" value="KPIs" sub="conectados a datos reales" accent="#9CA39A" />
      </div>
...
function AccesosView() {
  ...
  // AccesosView trabaja solo con datos de ejemplo por ahora
  // (la versión real requiere buscar en Supabase por CUIT)
  const lista = [];
  const habilitados = 0;
  const empresaEncontrada = null;
  const motivo = () => null;
